          ...
          ${
            ...
            <div class="consumer-card__body">
              ...
              <div class="consumer-card__actions">
                <button
                  type="button"
                  class="consumer-card__icon-btn consumer-card__icon-btn--star"
                  data-action="save-to-library"
                  aria-label="Зберегти в типові"
                  title="Зберегти в типові"
                >★</button>
                <button
                  type="button"
    ...
    this.shadowRoot.querySelectorAll('[data-action]').forEach((btn) => {
      btn.addEventListener('click', (event) => {
        ...
        if (action === 'remove') {
          ...
          const { id, zoneId, ...template } = consumer;
          this.dispatchEvent(new CustomEvent('consumer-save-to-library', {
            detail: { template },
            bubbles: true, composed: true,
          }));
        }
