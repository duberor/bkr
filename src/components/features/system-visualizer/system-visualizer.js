      ...
      <ui-card padding="md">
        <section class="visualizer">
          <div class="visualizer__head">
            <p class="visualizer__eyebrow">Візуальна схема</p>
            <h2>Як працює система</h2>
          </div>

          <div class="visualizer__scheme-card">
            <div class="visualizer__flow">
              <div class="node"><span>Вхід AC</span><strong>Мережа / генератор</strong></div>
              <div class="arrow">→</div>
              <div class="node"><span>Перемикання / заряд</span><strong>ATS + зарядний пристрій</strong></div>
              <div class="arrow">→</div>
            ...
            <div class="visualizer__flow visualizer__flow--battery">
              ...
              <div class="arrow">⇄</div>
              <div class="node"><span>DC захист</span><strong>${formatNumber(designDcCurrent, 0)} A / ${formatNumber(surgeDcCurrent, 0)} A</strong></div>
              <div class="arrow">⇄</div>
              <div class="node"><span>Корисна енергія</span><strong>${formatEnergyWh(usableEnergyWh)}</strong></div>
            </div>
          </div>
