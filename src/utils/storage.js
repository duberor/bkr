...
export function loadSystemSettings() {
  ...
  return {
    ...
    selectedBatteryConfigIndex: Number.isFinite(Number(parsed?.selectedBatteryConfigIndex))
      ? Math.max(0, Math.floor(Number(parsed.selectedBatteryConfigIndex)))
      : defaultSettings.selectedBatteryConfigIndex,
  ...
  try {
    localStorage.setItem(
      ...
      JSON.stringify({
        ...
        selectedBatteryConfigIndex: Number.isFinite(Number(settings?.selectedBatteryConfigIndex))
          ? Math.max(0, Math.floor(Number(settings.selectedBatteryConfigIndex)))
          : defaultSettings.selectedBatteryConfigIndex,
